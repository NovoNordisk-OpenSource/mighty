...
generating ADSL based on the specifications
    ...
    #> → Found "/tmp/RtmpVkUt9i/mighty_example_study/age_group_01.R" in "NovoNordisk-OpenSource/mighty.standards/components@dev/internal-components"
    ...
    #> → Found "mighty_write_data" in "NovoNordisk-OpenSource/mighty.standards/components@dev/internal-components"
    # ADSL-1-read_data -------------------------------------------------------------
    cnt <- connector::connect(config = "/tmp/RtmpVkUt9i/mighty_example_study/_connector.yml")
